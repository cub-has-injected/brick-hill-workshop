...
var selected_index:int setget set_selected_index
...
func _init()->void :
	...
	button_group.resource_name = "Surface Picker"
...
func _enter_tree()->void :
	...
	for i in range(0, BrickHillResources.SURFACE_ICONS.size()):
		var key = BrickHillResources.SURFACE_ICONS.keys()[i]
		var texture = BrickHillResources.SURFACE_ICONS[key]
		var value = BrickHillResources.SURFACE_BITMASKS[key]
